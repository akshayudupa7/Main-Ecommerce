  ...
  return (
    <div className={Ral.className}>
      <Box sx={{width:"100%",display:"flex",alignItems:"center",flexDirection:"column",backgroundColor:"black"}}>
        ...
        <Box sx={{width:"30%",backgroundColor:"rgb(28,20, 20)",padding:'50px 40px', marginTop:3,marginBottom:3,boxShadow: '0 4px 8px rgba(190, 40, 220, 0.1)'}}>
            <Typography sx={{color:"#fff",fontSize:"24px"}}>Register</Typography>
